...
class CompanyItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<HomeController>(builder: (controller) => GestureDetector(
      onTap: () {
        Get.bottomSheet(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              Row(
                children: [
                  Image.network( company.thumbnailUrl ?? '',width: 20,height: 20,),
                  SizedBox(width: 30,),
                  Column(crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      Text(
                        restrictToTwoWords(company.title ?? ''),
                        style:
                        const TextStyle(fontSize: 16, fontWeight: FontWeight.bold,),maxLines: 1,
                      ),
                    ],
                  ),
                ],
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: (company.isApplied ?? false) ? Colors.greenAccent : Colors.blueAccent,
